...
SECRET_KEY = 'django-insecure-v80vtzjs7nbccjyrwrd+w3@(9$_cjvh*1b$i1&17d0@dd=wnap'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["aniquestudentportal.pythonanywhere.com",'localhost']
...
STATIC_ROOT = os.path.join(BASE_DIR,'student_portal/static_root')
